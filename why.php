...
<nav class="navbar navbar-default navbar-transparent navbar-fixed-top" style="background-color: white;">
            ...
            <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right" style="margin-right:30px; margin-top:30px;">
                        <div>
                            ...
                            &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a style="color: #104C66; font-size: large; margin-bottom: -1px;" href="mengapa.php"><strong>ID</strong></a>
                            &nbsp;&nbsp;<a href="#"><img height="25px" src="./assets/img/i.png"></a>
                            &nbsp;&nbsp;<a style="color: #104C66; font-size: large; margin-bottom: -1px" href="why.php"><strong>EN</strong></a>
                        </div>
                    </ul>
                </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-member" style="height: 500px;">
                        <div class="row">
